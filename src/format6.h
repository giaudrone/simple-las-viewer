...
typedef struct
{
  ...
  double minZ;                        // Min Z
  uint64_t
      startWaveformDataPacketRecord; // Start of Waveform Data Packet Record
  uint64_t startFirstExtendedVarLengthRecord; // Start of First Extended
                                              // Variable Length Record
  uint32_t numExtendedVarLengthRecords; // Number of Extended Variable Length
                                        // Records
